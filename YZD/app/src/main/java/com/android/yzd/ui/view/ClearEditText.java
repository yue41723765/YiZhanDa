...
public class ClearEditText extends android.support.v7.widget.AppCompatEditText implements View.OnFocusChangeListener,
    ...
    private void init(Context context, AttributeSet attrs) {
        setTextSize(13f);
        setSingleLine();
        setTextColor(getResources().getColor(R.color.black_30));
...
//        setBackgroundResource(ta.getResourceId(R.styleable.ClearEditText_setBackGround, getResources().getColor(android.R.color.white)));
//        ta.recycle();
